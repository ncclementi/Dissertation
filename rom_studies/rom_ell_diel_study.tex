...
\begin{figure}%[h] %  figure placement: here, top, bottom, or page
    \centering
    \includegraphics[width=0.65\textwidth]{convergence_sensor_pca_w380.pdf} 
...
\begin{figure}%[h] %  figure placement: here, top, bottom, or page
    \centering
    \includegraphics[width=0.65\textwidth]{pqr_analysis_pca.pdf} 
...
\begin{figure}%[h] %  figure placement: here, top, bottom, or page
    \centering
    \includegraphics[width=0.65\textwidth]{convergence_sensor_ve_w380.pdf} 
    \caption{Grid-convergence study of extinction cross-section of a spherical silver
...
After performing the convergence analysis, we relaxed the numerical parameters of the computations to reduce the runtime without 
...
\begin{figure} %[h] %  figure placement: here, top, bottom, or page
    \centering
    \includegraphics[width=0.65\textwidth]{two_ell_analysis.pdf} 
...
\begin{figure} %[h] %  figure placement: here, top, bottom, or page
    \centering
    \includegraphics[width=0.65\textwidth]{two_ve_ell_sph_vs_BSA.pdf} 
    \caption{Extinction cross-section as a function of wavelength for an $8$ nm
...
and finally a configuration where the principal axis $b$ is parallel to $y$ (see Figure \ref{fig:two_ve_conf_display} for configurations). 
 ...
 \begin{figure} %[h] %  figure placement: here, top, bottom, or page
    \centering
    \includegraphics[width=0.55\textwidth]{viz/two_ve_conf_display.pdf} 
 ...
 \begin{figure} %[h] %  figure placement: here, top, bottom, or page
     \centering
     \includegraphics[width=0.65\textwidth]{two_ve_ell_mult_config.pdf} 
     \caption{Extinction cross-section as a function of wavelength for an $8$ nm
...
\begin{figure} %[h] %  figure placement: here, top, bottom, or page
    \centering
    \includegraphics[width=0.65\textwidth]{six_ve_ell_mult_config.pdf} 
    \caption{Extinction cross-section as a function of wavelength for an $8$ nm
...
\begin{figure}%[t] %  figure placement: here, top, bottom, or page
    \centering
    \subfloat{\includegraphics[width=0.65\textwidth]{VE_ell_cm_elec_field_var.pdf}}\\
    \subfloat{\includegraphics[width=0.65\textwidth]{VE_ell_cm_elec_field_var_zoom.pdf}} 
    \caption{Extinction cross-section as a function of wavelength for an $8$ nm
...
\begin{figure} %[h] %  figure placement: here, top, bottom, or page
    \centering
    \includegraphics[width=0.65\textwidth]{bsa_diel_study.pdf} 
...
\begin{figure} %[h] %  figure placement: here, top, bottom, or page
    \centering
    \includegraphics[width=0.65\textwidth]{iso_np_water_diel_study.pdf} 
...
but also the shift when proteins are added in the vicinity. 
 ...
 \begin{figure} %[h] %  figure placement: here, top, bottom, or page
    \centering
    \includegraphics[width=0.65\textwidth]{bsa_w_real_water_diel.pdf} 
    \caption{Comparison of LSPR response of a silver nanoparticle to two BSA proteins located at $\pm1$ nm on the $z$-direction
...
LSPR response. 
 ...
 \begin{figure} %[h] %  figure placement: here, top, bottom, or page
    \centering
    \includegraphics[width=0.65\textwidth]{bsa_phan_avg_real_water_diel.pdf} 
    \caption{Comparison of LSPR response of a silver nanoparticle to two BSA proteins located at $\pm1$ nm on the $z$-direction
