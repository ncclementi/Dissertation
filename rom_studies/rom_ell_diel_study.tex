...
to represent the protein, and often a real-valued dielectric for the medium. Some models comprise of  
...
difference in the LSPR response, wether we use the complex dielectric for the water or an averaged value of the real component of it. However, when using a
