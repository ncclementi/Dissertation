...
\begin{figure}
 ...
 but we realized that the mesher does not produce a uniform mesh and that we were not able to obtained one with the functions available. To solve this problem 
 and obtained the uniform meshes by creating our own Python script.
